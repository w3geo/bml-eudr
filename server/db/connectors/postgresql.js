// Patched version of posgtresqlConnector, anticipating https://github.com/unjs/db0/issues/131
import pg from 'pg';

/**
 * @param {*} opts
 * @returns {import('db0').Connector & { getInstance: () => import('pg').Client|Promise<import('pg').Client>} }}
 */
